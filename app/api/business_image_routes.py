...
@business_image_routes.route('/<int:business_id>/images')
...
@business_image_routes.route('/<int:business_id>/images', methods=['POST'])
@login_required
...
@business_image_routes.route('/images/<int:image_id>', methods=['PUT'])
@login_required
...
@business_image_routes.route('/images/<int:image_id>', methods=['DELETE'])
@login_required
